...
class Test005CheckKycTest(unittest.TestCase):
    def test_check_kyc_200(self):
        ...
        response = silasdk.User.checkKyc(app, payload, eth_private_key)

        payload = {
            "user_handle": user_handle_2
        }
        response_2 = silasdk.User.checkKyc(app, payload, eth_private_key_2)

        payload = {
            "user_handle": business_handle
        }
        response_3 = silasdk.User.checkKyc(app, payload, eth_private_key_3)
